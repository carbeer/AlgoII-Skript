...
Mithilfe von Fibonacci-Heaps erhalten wir eine amortisierte Komplexität von \( O(\log n) \) für \code{deleteMin} und \code{remove} und \( O(1) \) für alle anderen Operationen.
